...
export const PASSPORTS = utils.parsePassportBatchFile(data);

export const FIELD_VALIDATORS = {
    byr: function (value) {
        return !!value && value.length === 4 && utils.valueIsBetween(value, 1920, 2002);
    },
    iyr: function (value) {
        return !!value && value.length === 4 && utils.valueIsBetween(value,2010, 2020);
    },
    eyr: function (value) {
        return !!value && value.length === 4 && utils.valueIsBetween(value, 2020, 2030);
    },
    hgt: function (value) {
        return !!value && utils.isValidHeight(value);
    },
    hcl: function (value) {
        return !!value && value.length === 7 && /(#[0-9a-f]{6})/.test(value)
    },
    ecl: function (value) {
        return !!value && ['amb', 'blu', 'brn', 'gry', 'grn', 'hzl', 'oth'].some((validColor) => value === validColor);
    },
    pid: function (value) {
        return !!value && value.length === 9 && /([0-9]{9})/.test(value);
    },
    cid: function (value) {
        return true;
    },
